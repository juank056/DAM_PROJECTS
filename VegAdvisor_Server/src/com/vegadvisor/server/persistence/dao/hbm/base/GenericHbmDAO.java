...
import com.vegadvisor.server.persistence.FieldCondition;
import com.vegadvisor.server.persistence.bo.AbstractBO;
import com.vegadvisor.server.persistence.dao.GenericDAO;
...
public class GenericHbmDAO<T extends AbstractBO<PK>, PK extends Serializable>
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected List<T> findByCriteria(List<Criterion> criterions, Order order)
			throws DAOException {
		// Sesion y transaccion locales
		Session local_session = null;
		Transaction local_tx = null;
	...
	/**
	 * Busca objetos por criterios y dos ordenes
	 * 
	 * @param criterions
	 *            los criterios por los que se quieren buscar los objetos
	 * @param order1
	 *            El primer orden orden por el que se quiere retornar
	 * @param order2
	 *            El Segundo orden orden por el que se quiere retornar
	 * @return lista de objetos que fueron encontrados
	 * @throws DAOException
	 *             en caso de error con la base de datos
	 */
	@SuppressWarnings("unchecked")
	protected List<T> findByCriteria(List<Criterion> criterions, Order order1,
			Order order2) throws DAOException {
		// Sesion y transaccion locales
		Session local_session = null;
		Transaction local_tx = null;
		List<T> objects = null;
