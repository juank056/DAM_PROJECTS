...
import com.vegadvisor.server.utils.DBDataChiper;
...
public class HibernateFactory {
	...
	private static SessionFactory configureSessionFactory()
		...
		configuration.setProperty("hibernate.connection.url",
				ConfigApplicationManager.getParameter("com.esf.db.url"));
		// 2. Driver de la base de datos
		configuration.setProperty("hibernate.connection.driver_class",
				ConfigApplicationManager.getParameter("com.esf.db.driver"));
		// 3. Nombre del Usuario
		configuration.setProperty(
				"hibernate.connection.username",
				DBDataChiper.decrypt(ConfigApplicationManager.getParameter(
						"com.esf.db.username").trim()));
		// 4. Password del Usuario
		configuration.setProperty(
				"hibernate.connection.password",
				DBDataChiper.decrypt(ConfigApplicationManager.getParameter(
						"com.esf.db.passwd").trim()));
		// 5. Dialecto de la base de datos
		configuration.setProperty("hibernate.dialect",
				ConfigApplicationManager.getParameter("com.esf.db.dialect"));
