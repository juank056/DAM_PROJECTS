...
public class Fomhilfo implements java.io.Serializable, AbstractBO<Integer> {
	...
	public void cleanObject() {
		try {
			...
			this.userName = usuar.getUsunusuaf() + Constants.BLANK_SPACE
					+ usuar.getUsuapelaf();
			// Dao para leer respuestas al foro
			IFodreshiDAO fodreshiDao = SpringAppContext.getAppContext()
					.getBean(IFodreshiDAO.class);
			// Busca respuestas del hilo
			this.responses = fodreshiDao.findByParent(hifchifnk);
