...
public class DateUtils {
	 ...
	 * 
	 * @param date
	 *            la fecha a la que se le va a realizar el corrimiento
	 * @param days
	 *            el numero de dias que se va a correr (positivo o negativo)
